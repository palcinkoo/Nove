...
export type ConsoleTab = "overview" | "devices" | "activity";
...
const NAV: Array<{ id: ConsoleTab; label: string; desc: string }> = [
  { id: "overview", label: "Overview", desc: "Fleet status" },
  { id: "devices", label: "Devices", desc: "Telemetry & pairing" },
